...
import { Printer, Eye, XCircle, Loader2, Search, Users } from "lucide-react";
...
const FailledId = () => {
  ...
  const filteredCitizens = citizens
    .filter((c) => (c.printStatus || "").toLowerCase() === "failed")
    .filter((c) => {
    ...
    <div className="min-h-screen bg-stone-100 p-6">
      ...
      {loading ? (
        ...
        <div className="bg-white p-6 rounded-lg shadow text-center text-stone-600">
          No citizens found with failed print status.
        </div>
      ) : (
